(defproject fifteen "0.1.0-SNAPSHOT"
  ...
  :plugins [[lein-cljsbuild "1.0.4"]
            ...
            [lein-environ "1.0.0"]
            [lein-ring "0.9.1"]
            [lein-asset-minifier "0.2.3-SNAPSHOT"]
            [lein-exec "0.3.4"]
            [lein-pdo "0.1.1"]
  ...
  :ring {:handler fifteen.server.handler/app}
  ...
  :garden {:builds [{:id "prod"
                     ...
                     :stylesheet fifteen.styles.site/site
  ...
  :profiles {:dev {:repl-options {:init-ns fifteen.server.handler
